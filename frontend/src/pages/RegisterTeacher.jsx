    ...
    <div className="registration-layout">
        ...
        <div className="registration-card">
          <div className="registration-header">
            ...
            <p className="subtitle">
              Register as a teacher to create and manage exams and questions
            </p>
          </div>
      ...
      <div className="registration-info-panel">
        ...
        <div className="info-content">
          <div className="info-badge">Teacher Portal</div>
          <h1 className="info-title">Exam Management System</h1>
          <p className="info-text">
            As a teacher, you'll be able to create exams, manage questions, and track student
            performance through our comprehensive assessment platform.
          </p>
          ...
          <div className="info-points">
            ...
            <div className="info-point">
              <span className="info-icon">✓</span>
              <p>Track student progress and results</p>
            </div>
          </div>
        </div>
      </div>
