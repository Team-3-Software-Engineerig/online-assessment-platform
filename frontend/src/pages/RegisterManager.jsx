    ...
    <div className="registration-layout">
        ...
        <div className="registration-card">
          <div className="registration-header">
            ...
            <p className="subtitle">
              Register as a manager to access student lists and contact information
            </p>
          </div>
      ...
      <div className="registration-info-panel">
        ...
        <div className="info-content">
          ...
          <h1 className="info-title">Student Data Management</h1>
          <p className="info-text">
            As a manager, you'll have access to student lists, contact information, and assessment
            data to help you make informed decisions and track student progress.
          </p>

          <div className="info-points">
            <div className="info-point">
              <span className="info-icon">✓</span>
              <p>View student lists and profiles</p>
            </div>
            <div className="info-point">
              <span className="info-icon">✓</span>
              <p>Access contact information</p>
            </div>
            <div className="info-point">
              <span className="info-icon">✓</span>
              <p>Review assessment results and reports</p>
            </div>
          </div>
        </div>
      </div>
